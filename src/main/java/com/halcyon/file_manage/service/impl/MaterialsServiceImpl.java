...
@Service
@Transactional
public class MaterialsServiceImpl extends AbstractService<Materials> implements MaterialsService {
    @Resource
    private MaterialsMapper materialsMapper;

	@Override
	public List<Materials> selectByLikeName(SearchType searchType) {
		// TODO Auto-generated method stub
		return materialsMapper.selectWithConditionLike(searchType);
	}
